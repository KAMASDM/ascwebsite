...
function getSteps() {
    return ['Contact Information', 'E-commerce Details', 'Additional Features'];
}
            ...
            return (
                <Box sx={{ padding: 3 }}>
                    <FormControl component="fieldset" fullWidth margin="normal">
                        <FormLabel component="legend">Type of E-commerce Platform</FormLabel>
                        <RadioGroup
                            ...
                            row
                        >
                            <FormControlLabel value="smallBusiness" control={<Radio />} label="Small Business" />
                            <FormControlLabel value="enterprise" control={<Radio />} label="Enterprise" />
                            <FormControlLabel value="marketplace" control={<Radio />} label="Marketplace" />
            ...
            return (
                <Box sx={{ padding: 3 }}>
                    <FormControl component="fieldset" fullWidth margin="normal">
                        ...
                        />
                        <FormControlLabel
                            control={<Checkbox checked={form.analytics} onChange={handleChange} name="analytics" />}
                            label="Analytics Tools"
                        />
                        <FormControlLabel
                            control={<Checkbox checked={form.crmIntegration} onChange={handleChange} name="crmIntegration" />}
            ...
            <div>
                {activeStep === steps.length ? (
                    ...
                    <div>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'row', pt: 2, justifyContent: 'flex-end', m: 3 }}>
                            <Button

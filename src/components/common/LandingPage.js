...
import {
  ThemeProvider, createTheme, useMediaQuery, CssBaseline, Container, Box,
  Typography, Button, Grid, BottomNavigation, BottomNavigationAction,
} from '@mui/material';
...
function LandingPage() {
  ...
  return (
    <ThemeProvider theme={theme}>
      <CssBaseline />
      <Container sx={{ width: '100vw', padding: 0, margin: 0, overflowX: 'hidden' }}>
      <Box sx={{ my: 2 }}>
        <SimpleBreadcrumbs />
        ...
        <Box sx={{
          ...
          <Typography variant="h5" sx={{ mb: 3, maxWidth: '600px', textAlign: 'center' }}>
        ...
        <Grid container spacing={4} sx={{ px: 3, py: 5 }}>
          <Grid item xs={12}><ServiceSection /></Grid>
          <Grid item xs={12}><SolutionsComponent /></Grid>
          <Grid item xs={12}><AboutUsComponent /></Grid>
          <Grid item xs={12}><BlogComponent /></Grid>
        </Grid>
        ...
        {isMobile && (
          ...
          >
            <BottomNavigationAction label="About Us" icon={<InfoIcon />} value={0} />
            <BottomNavigationAction label="Services" icon={<ServicesIcon />} value={1} />
            <BottomNavigationAction label="Home" icon={<HomeIcon />} value={2} />
            <BottomNavigationAction label="Solutions" icon={<SolutionsIcon />} value={3} />
